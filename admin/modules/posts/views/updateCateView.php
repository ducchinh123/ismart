        ...
        <div id="content" class="fl-right">
            ...
            <div class="section" id="detail-page">
                <div class="section-detail">
                    <form action="?mod=posts&action=editCate&id=<?php echo $info_cate['id']; ?>" method="POST">
                        ...
                        <select name="parent-Cat">
                            ...
                            ?>
                                ...
                                <option value="<?php echo $cate['id']; ?>" <?php if ($info_cate['parent_id'] == $cate['id']) echo "SELECTED"; ?>><?php echo str_repeat("|---", $cate['level']) .  $cate['name']; ?></option>
